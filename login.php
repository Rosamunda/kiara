<a href="#" data-reveal-id="myModal" class="panel right"><b>Ingresar</b></a>
<div id="myModal" class="reveal-modal" data-reveal>
    <form name="loguearse" action="" method="POST">
    <h2>Acceso usuarios registrados</h2>
    Usuario: <input type="text" name="usuario" /> 
    Clave: <input type="text" name="clave" />
    <input type="submit" name="submit" class="button [radius round alert]" value="Entrar!">
    <br>
    </form>
</div>
...
if($_SERVER['REQUEST_METHOD']=='POST'){
    ...
    */
    ...
    //preparamos la consulta, luego conectamos cada signo ? con su respectivo valor
    //(con mysqli_stmt_bind_param), luego ejecutamos la consulta
    ...
    if ($consulta) {
        ...
        //el primer parámetro de _bind_result es la consulta a la base
        //y luego cada variable corresponde a cada columna
        mysqli_stmt_bind_result($consulta, $usuario, $clave);
        
            //si obtenemos algún resultado con mysqli_stmt_fetch()...
